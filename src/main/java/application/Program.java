...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        String[] itens = {"Cadastrar Usu�rio", "Cadastrar Livro", "Sair"};
        String selecao = (String) JOptionPane.showInputDialog(null, "Escolha um item", "Cadastro",
                JOptionPane.INFORMATION_MESSAGE, null, itens, itens[0]);

        while (selecao != "Sair") {

            if (selecao.equals("Cadastrar Usu�rio")) {
                UsuarioDao usuarioDao = DaoFactory.createUsuarioDao();

                String[] opUsuario = {"Inserir Usu�rio", "Atualizar Usu�rio", "Selecionar Usu�rio",
                    "Listar Usu�rios Cadastrados", "Voltar"};
                String escolhaUsuario = (String) JOptionPane.showInputDialog(null, "Escolha um item",
                        "Cadastro de Usu�rio", JOptionPane.INFORMATION_MESSAGE, null, opUsuario, opUsuario[0]);

                while (escolhaUsuario != "Voltar") {
                    switch (escolhaUsuario) {

                        case "Inserir Usu�rio":
                        ...
                        case "Atualizar Usu�rio":
                            System.out.println("\n=== TESTE 2: update usu�rio ===");
                        ...
                        case "Selecionar Usu�rio":
                            System.out.println("=== TESTE 3: achar usu�rio por ID ===");
                            Usuario newUsuario = usuarioDao.findById(1);
                            System.out.println(newUsuario);
                            break;

                        case "Listar Usu�rios Cadastrados":
                            System.out.println("\n=== TESTE 4: retornar todos os usu�rios ===");
